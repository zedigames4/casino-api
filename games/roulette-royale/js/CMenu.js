function CMenu(){
    ...
    this._init = function(){
        ...
        _pStartPosMenu = {x:CANVAS_WIDTH - oSprite.width + oSprite.width/2,y:(oSprite.height / 2) + 60};

        _oMenuButton = new CGfxButton(_pStartPosMenu.x, _pStartPosMenu.y, oSprite,s_oStage);
    ...
    this.refreshButtonPos = function (iNewX, iNewY) {
        ...
        _oMenuButton.setPosition(_pStartPosMenu.x - iNewX, _pStartPosMenu.y + iNewY)
    };
